...
class ListRoutesForBidComponent extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    RouteService.getRouteByIdBid(this.state.id)
      .then((res) => {
        this.setState({
          route: res.data,
          loading: true,
      ...
      return (
        <div className="container">
          <header className="jumbotron">
            <h2 class="mb-5">Маршруты по заявке №{this.state.id}</h2>
            <div className="row">
...
export default ListRoutesForBidComponent;